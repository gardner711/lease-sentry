...
The User Profile data is exchanged through GET and POST operations in the web service API (/userprofile) saved in object store in collection called Profile by the user's unique id
