...
## Technical Overview
### Purpose
Standard function template using the serverless function pattern for Node.js: module.exports = async function (context, req)
...
|------------|-------------|
| ENB-613819 | Azure Function Runtime |
| ENB-613840 | HTTP Trigger Handler |
| ENB-613860 | Function Bindings |
