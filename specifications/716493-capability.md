...
## Technical Overview
### Purpose
Provides the capabilities to deploy the following Azure resources for project:
- Azure Static Web App for the web-site component
- Azure Web app for the web-service component
- Azure Serverless Function for the function component
- Azure Cosmos Db for document storage
- Azure Blob Storage for file storage
- Azure AI Search per document for AI queries
- Azure Event Grid for bus messages
- Azure App Service Authentication (Easy Auth) for identity

## Enablers

| Enabler ID | Description |
|------------|-------------|
| ENB-716494 | Azure Static Web App Deployment |
| ENB-716518 | Azure Web App Deployment |
